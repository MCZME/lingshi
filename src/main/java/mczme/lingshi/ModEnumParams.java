...
public class ModEnumParams {
    ...
    public static final EnumProxy<RecipeBookCategories> COOKING_POT_BOIL_ENUM_PROXY = new EnumProxy<>(RecipeBookCategories.class, params(ModItems.RICE_OF_EAR.get()));
    public static final EnumProxy<RecipeBookCategories> COOKING_POT_STEW_ENUM_PROXY = new EnumProxy<>(RecipeBookCategories.class, params(ModItems.RICE.get()));
    public static final EnumProxy<RecipeBookCategories> COOKING_POT_DEEP_FRY_ENUM_PROXY = new EnumProxy<>(RecipeBookCategories.class, params(ModItems.IRON_KNIFE.get()));
    public static final EnumProxy<RecipeBookCategories> COOKING_POT_MISC_ENUM_PROXY = new EnumProxy<>(RecipeBookCategories.class, params(Items.WHEAT));
